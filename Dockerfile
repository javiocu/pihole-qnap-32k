...
RUN apk update && apk add --no-cache \
    ...
    vim \
    # (El paquete 'vim' trae el binario 'xxd' completo)
...
# COMPROBACIÓN (Para que no falle el build)
# Nos aseguramos de que 'xxd' apunta al binario bueno, no a busybox
...
# Incluimos ca-certificates, curl, sqlite3, cron, etc.
